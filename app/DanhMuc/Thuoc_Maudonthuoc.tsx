...
const SAMPLE_DATA: Thuoc[] = [
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Uống 3 lần/ngày, sau bữa ăn, mỗi lần 1 viên",
    hoatChat: "Amoxicillin Trihydrate",
    giaNhap: 3000,
    giaBan: 5000,
    maVach: "8934588011234",
  ...
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Uống 2 lần/ngày, sáng và tối sau ăn",
    hoatChat: "Metronidazole",
    giaNhap: 2000,
    giaBan: 3500,
    maVach: "8934588012345",
    nhomThuoc: "Kháng sinh",
    khoThuoc: "Kho chính",
    hienThi: true,
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Uống 3-4 lần/ngày, cách đều 6-8 giờ",
    hoatChat: "Clindamycin HCl",
    giaNhap: 5000,
    giaBan: 8000,
    maVach: "8934588013456",
    nhomThuoc: "Kháng sinh",
    khoThuoc: "Kho chính",
    hienThi: false,
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung:
      "Uống khi đau hoặc sốt, cách 4-6 giờ/lần, không quá 4g/ngày",
    hoatChat: "Paracetamol",
    giaNhap: 800,
    giaBan: 2000,
    maVach: "8934588014567",
  ...
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Uống sau ăn, 2-3 lần/ngày, không dùng quá 5 ngày",
    hoatChat: "Ibuprofen",
    giaNhap: 2500,
    giaBan: 4000,
    maVach: "8934588015678",
    nhomThuoc: "Giảm đau - Hạ sốt",
    khoThuoc: "Kho chính",
    hienThi: true,
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Theo chỉ định bác sĩ, thường 2-4 lần/ngày",
    hoatChat: "Dexamethasone",
    giaNhap: 1500,
    giaBan: 3000,
    maVach: "8934588016789",
    nhomThuoc: "Kháng viêm",
    khoThuoc: "Kho chính",
    hienThi: true,
  },
  {
    ...
    donVi: "viên",
    huongDanSuDung: "Uống 1 viên/ngày sau ăn sáng",
    hoatChat: "Ascorbic Acid",
    giaNhap: 3000,
    giaBan: 8000,
    maVach: "8934588017890",
  ...
  },
  {
    ...
    donVi: "chai",
    huongDanSuDung: "Súc miệng 3-4 lần/ngày sau khi ăn",
    hoatChat: "Sodium Chloride",
    giaNhap: 8000,
    giaBan: 15000,
    maVach: "8934588018901",
    nhomThuoc: "Răng miệng",
    khoThuoc: "Kho nha khoa",
    hienThi: true,
  },
  {
    id: 9,
    ...
    donVi: "chai",
    huongDanSuDung: "Súc miệng 30 giây, không nuốt, dùng 2 lần/ngày",
    hoatChat: "Chlorhexidine Gluconate",
    giaNhap: 20000,
    giaBan: 35000,
    maVach: "8934588019012",
    nhomThuoc: "Răng miệng",
    khoThuoc: "Kho nha khoa",
    hienThi: true,
  },
...
const Thuoc_Maudonthuoc: React.FC = () => {
  ...
  filteredData.forEach((t) => {
    if (!NHOM_THUOC_LIST.includes(t.nhomThuoc) && t.nhomThuoc) {
      ...
      if (!groupMap[t.nhomThuoc].find((x) => x.id === t.id))
        groupMap[t.nhomThuoc].push(t);
    }
  });
  ...
  const openEdit = (t: Thuoc) => {
    ...
    setForm({
      ...
      tenThuoc: t.tenThuoc,
      donVi: t.donVi,
      huongDanSuDung: t.huongDanSuDung,
      hoatChat: t.hoatChat,
      giaNhap: t.giaNhap,
      giaBan: t.giaBan,
      maVach: t.maVach,
      nhomThuoc: t.nhomThuoc,
      khoThuoc: t.khoThuoc,
      hienThi: t.hienThi,
    });
    setFormVisible(true);
  ...
  const saveThuoc = () => {
    ...
    if (editItem) {
      setData((prev) =>
        prev.map((t) => (t.id === editItem.id ? { ...editItem, ...form } : t)),
      );
    } else {
  ...
  const deleteThuoc = (id: number) => {
    Alert.alert("Xác nhận xoá", "Bạn có chắc muốn xoá thuốc này?", [
      { text: "Huỷ", style: "cancel" },
      {
        text: "Xoá",
        style: "destructive",
        onPress: () => setData((prev) => prev.filter((t) => t.id !== id)),
      },
    ]);
  };
  ...
  const toggleHienThi = (id: number) => {
    setData((prev) =>
      prev.map((t) => (t.id === id ? { ...t, hienThi: !t.hienThi } : t)),
    );
  };
        ...
        <View style={formStyles.dropdown}>
          {options.map((opt) => (
            <TouchableOpacity
              ...
              style={[
                formStyles.dropItem,
                value === opt && formStyles.dropItemActive,
              ]}
              onPress={() => onSelect(opt)}>
              <Text
                style={[
                  formStyles.dropItemText,
                  value === opt && { color: B.primary, fontWeight: "700" },
                ]}>
                {opt}
              </Text>
              {value === opt && (
                <Ionicons name="checkmark" size={14} color={B.primary} />
              )}
            </TouchableOpacity>
          ))}
        </View>
        ...
        <View style={styles.searchCard}>
          <View style={styles.searchBox}>
            ...
            <TextInput
              ...
              placeholder="Tìm tên thuốc, mã thuốc, hoạt chất, mã vạch..."
                    ...
                    <View style={styles.groupTitleRow}>
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.groupSub}>
                          {items.length} thuốc · {hienThiCount} đang hiện
                        </Text>
                      </View>
                      <View style={styles.groupChips}>
                        <View style={styles.groupChip}>
                          <Text style={styles.groupChipNum}>
                            {items.length}
                          </Text>
                  ...
                  <View style={styles.thuocList}>
                    {items.map((thuoc, idx) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.thuocCard,
                          !thuoc.hienThi && styles.thuocCardHidden,
                        ]}
                        ...
                        <View
                          ...
                          <Text
                            style={[
                              styles.thuocIndexText,
                              { color: thuoc.hienThi ? B.primary : B.textSub },
                            ]}>
                        ...
                        <View style={{ flex: 1, gap: 4 }}>
                          ...
                          <View style={styles.thuocMetaRow}>
                            <View style={styles.thuocDonViChip}>
                              <Text style={styles.thuocDonViText}>
                                {thuoc.donVi}
                              </Text>
                            </View>
                            <View style={styles.thuocPriceGroup}>
                              <View style={styles.thuocPriceItem}>
                                ...
                                <Text style={styles.thuocGiaNhap}>
                                  {formatMoney(thuoc.giaNhap)}
                                </Text>
                              </View>
                              <View style={styles.thuocPriceSep} />
                              <View style={styles.thuocPriceItem}>
                                <Text style={styles.thuocPriceLabel}>Bán</Text>
                                <Text style={styles.thuocGiaBan}>
                                  {formatMoney(thuoc.giaBan)}
                                </Text>
                              </View>
                            </View>
                          </View>
                          ...
                          {thuoc.huongDanSuDung ? (
                            <View style={styles.thuocHDSDRow}>
                              <Ionicons
                                ...
                                color={B.info}
                              />
                              <Text style={styles.thuocHDSD} numberOfLines={1}>
                                {thuoc.huongDanSuDung}
                              </Text>
                            </View>
                          ) : null}
            ...
            {detailItem && (
              <ScrollView
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.detailBadgeRow}>
                      ...
                      <View
                        ...
                        <Text
                          style={[styles.detailBadgeText, { color: B.info }]}>
                          {detailItem.donVi}
                        </Text>
                      </View>
                      {!detailItem.hienThi && (
                ...
                <View style={styles.priceRow}>
                  <View
                    style={[styles.priceBox, { backgroundColor: "#F8FAFC" }]}>
                    <Text style={styles.priceLabel}>Giá nhập</Text>
                    <Text style={styles.priceVal}>
                      {formatMoney(detailItem.giaNhap)}
                    </Text>
                  </View>
                  ...
                  <View
                    style={[styles.priceBox, { backgroundColor: "#FEF2F2" }]}>
                    <Text style={styles.priceLabel}>Giá bán</Text>
                    <Text style={[styles.priceVal, { color: B.primary }]}>
                      {formatMoney(detailItem.giaBan)}
                    </Text>
                  </View>
                  <View
                    style={[styles.priceBox, { backgroundColor: "#ECFDF5" }]}>
                    <Text style={styles.priceLabel}>Lợi nhuận</Text>
                    <Text style={[styles.priceVal, { color: B.success }]}>
                      {formatMoney(detailItem.giaBan - detailItem.giaNhap)}
                    </Text>
                  </View>
                </View>
                ...
                {[
                  {
                    icon: "flask-outline",
                    label: "Hoạt chất",
                    value: detailItem.hoatChat,
                  },
                  {
                    icon: "business-outline",
                    label: "Nhóm thuốc",
                    value: detailItem.nhomThuoc,
                  },
                  {
                    icon: "archive-outline",
                    label: "Kho thuốc",
                    value: detailItem.khoThuoc,
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: detailItem.huongDanSuDung,
                  },
                ].map((row) => (
          ...
          <View style={[styles.modalSheet, { maxHeight: "95%" }]}>
            ...
            <View style={styles.modalHeaderRow}>
              <Text style={styles.modalTitle}>
                {editItem ? "Sửa thông tin thuốc" : "Thêm thuốc mới"}
              </Text>
              <TouchableOpacity
            ...
            <ScrollView
              ...
              <View style={{ gap: 14, paddingBottom: 30 }}>
                  ...
                  <View style={[formStyles.field, { flex: 0.8 }]}>
                    ...
                    <View style={formStyles.inputWrap}>
                      ...
                      <TextInput
                        ...
                        value={form.maThuoc}
                        onChangeText={(v) => setForm({ ...form, maThuoc: v })}
                        placeholder="TH001"
                      />
                    </View>
                  </View>
                  <View style={[formStyles.field, { flex: 2 }]}>
                    ...
                    <View style={formStyles.inputWrap}>
                      ...
                      <TextInput
                        style={formStyles.input}
                        value={form.tenThuoc}
                        onChangeText={(v) => setForm({ ...form, tenThuoc: v })}
                ...
                <View style={formStyles.field}>
                  ...
                  <View style={formStyles.inputWrap}>
                    ...
                    <TextInput
                      style={formStyles.input}
                      value={form.hoatChat}
                      onChangeText={(v) => setForm({ ...form, hoatChat: v })}
                ...
                <DropdownField
                  ...
                  show={showDonVi}
                  onToggle={() => {
                    setShowDonVi(!showDonVi);
                    setShowNhom(false);
                    setShowKho(false);
                  }}
                  onSelect={(v) => {
                    setForm({ ...form, donVi: v });
                    setShowDonVi(false);
                  }}
                  icon="cube-outline"
                />
                ...
                <View style={formStyles.row}>
                  <View style={[formStyles.field, { flex: 1 }]}>
                    ...
                    <View style={formStyles.inputWrap}>
                      ...
                      <TextInput
                        style={formStyles.input}
                        value={form.giaNhap === 0 ? "" : String(form.giaNhap)}
                        onChangeText={(v) =>
                          setForm({
                            ...form,
                    ...
                    {form.giaNhap > 0 && (
                      <Text style={formStyles.moneyHint}>
                        {formatMoney(form.giaNhap)}
                      </Text>
                    )}
                  </View>
                  <View style={[formStyles.field, { flex: 1 }]}>
                    ...
                    <View
                      ...
                      <TextInput
                        style={formStyles.input}
                        value={form.giaBan === 0 ? "" : String(form.giaBan)}
                        onChangeText={(v) =>
                          setForm({
                            ...form,
                    ...
                    {form.giaBan > 0 && (
                      <Text
                        style={[formStyles.moneyHint, { color: B.primary }]}>
                        {formatMoney(form.giaBan)}
                      </Text>
                    )}
                  </View>
                </View>
                ...
                {form.giaBan > 0 && form.giaNhap > 0 && (
                  <View style={formStyles.profitBox}>
                    <Ionicons
                      name="trending-up"
                      size={14}
                      color={form.giaBan > form.giaNhap ? B.success : B.danger}
                    />
                    <Text style={formStyles.profitLabel}>Lợi nhuận:</Text>
                    <Text
                      style={[
                        formStyles.profitVal,
                        {
                          color:
                            form.giaBan > form.giaNhap ? B.success : B.danger,
                        },
                      ]}>
                    ...
                    <Text style={formStyles.profitPct}>
                      ...
                      {form.giaNhap > 0
                        ? Math.round(
                            ((form.giaBan - form.giaNhap) / form.giaNhap) * 100,
                          )
                        : 0}
                      %)
                    </Text>
                ...
                <View style={formStyles.field}>
                  ...
                  <View style={formStyles.inputWrap}>
                    ...
                    <TextInput
                      style={formStyles.input}
                      value={form.maVach}
                      onChangeText={(v) => setForm({ ...form, maVach: v })}
                ...
                <DropdownField
                  ...
                  show={showNhom}
                  onToggle={() => {
                    setShowNhom(!showNhom);
                    setShowDonVi(false);
                    setShowKho(false);
                  }}
                  onSelect={(v) => {
                    setForm({ ...form, nhomThuoc: v });
                    setShowNhom(false);
                  }}
                  icon="grid-outline"
                />
                ...
                <View style={formStyles.field}>
                  ...
                  <TextInput
                    ...
                    value={form.huongDanSuDung}
                    onChangeText={(v) =>
                      setForm({ ...form, huongDanSuDung: v })
                    }
                ...
                <View style={formStyles.switchRow}>
                  <View>
                    ...
                    <Text style={formStyles.switchSub}>
                      Thuốc sẽ xuất hiện trong danh sách kê đơn
                    </Text>
                  </View>
                  <Switch
                    value={form.hienThi}
            ...
            <View style={styles.modalFooter}>
              ...
              <TouchableOpacity style={styles.saveBtn} onPress={saveThuoc}>
                ...
                <Text style={styles.saveBtnText}>
                  {editItem ? "Lưu thay đổi" : "Thêm thuốc"}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
