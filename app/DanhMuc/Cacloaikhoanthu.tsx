...
const SAMPLE_DATA: LoaiKhoanThu[] = [
  {
    id: 1,
    tenLoai: "Thu khám bệnh",
    moTa: "Thu tiền khám và chẩn đoán bệnh nhân",
  },
  {
    id: 2,
    tenLoai: "Thu tiền bán thuốc",
    moTa: "Thu tiền bán thuốc và vật tư y tế",
  },
  {
    id: 3,
    tenLoai: "Thu dịch vụ kỹ thuật",
    moTa: "Thu tiền các dịch vụ kỹ thuật, thủ thuật",
  },
  {
    id: 4,
    tenLoai: "Thu tiền giường bệnh",
    moTa: "Thu phí lưu trú, nằm viện nội trú",
  },
  {
    id: 5,
    tenLoai: "Thu khác",
    moTa: "Các khoản thu phát sinh ngoài danh mục",
  },
];
...
const Cacloaikhoanthu: React.FC = () => {
  const router = useRouter();
  const [data, setData] = useState<LoaiKhoanThu[]>(SAMPLE_DATA);
  const [search, setSearch] = useState("");
  const [formVisible, setFormVisible] = useState(false);
  const [editItem, setEditItem] = useState<LoaiKhoanThu | null>(null);
  ...
  const openEdit = (item: LoaiKhoanThu) => {
    setEditItem(item);
  ...
  const handleSave = () => {
    if (!form.tenLoai.trim()) {
      setFormError("Vui lòng nhập tên loại khoản thu.");
      return;
    }
    ...
    if (isDuplicate) {
      setFormError("Tên loại khoản thu đã tồn tại.");
      return;
    }
    if (editItem) {
      setData((prev) =>
  ...
  const handleDelete = (item: LoaiKhoanThu) => {
    Alert.alert(
      "Xác nhận xoá",
      `Bạn có chắc muốn xoá loại khoản thu "${item.tenLoai}"?`,
      [
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView edges={["top"]} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.headerTitle}>Loại khoản thu</Text>
            <Text style={styles.headerSub}>Quản lý danh mục khoản thu</Text>
          </View>
      ...
      <ScrollView
        ...
        <View style={styles.searchCard}>
          <View style={styles.searchBox}>
            ...
            <TextInput
              ...
              placeholder="Tìm loại khoản thu, mô tả..."
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: "#FEF2F2" }]}>
            ...
            <View>
              ...
              <Text style={styles.statLabel}>Tổng loại thu</Text>
            </View>
          </View>
        </View>
        ...
        {filteredData.length === 0 ? (
          <View style={styles.emptyBox}>
            ...
            <Text style={styles.emptyTitle}>Chưa có loại khoản thu nào</Text>
            <Text style={styles.emptyText}>
              Nhấn nút + để thêm loại khoản thu mới
            </Text>
            <TouchableOpacity style={styles.emptyAddBtn} onPress={openAdd}>
              <Ionicons name="add-circle" size={16} color={B.primary} />
              <Text style={styles.emptyAddText}>Thêm loại khoản thu</Text>
            </TouchableOpacity>
          </View>
        ) : (
              ...
              <View style={styles.modalHeaderRow}>
                <View style={styles.modalHeaderLeft}>
                  ...
                  <Text style={styles.modalTitle}>
                    {editItem ? "Sửa loại khoản thu" : "Thêm loại khoản thu"}
                  </Text>
                </View>
                <TouchableOpacity
              ...
              <ScrollView
                ...
                <View style={[styles.formField, { marginTop: 16 }]}>
                  ...
                  <TextInput
                    ...
                    placeholder="Nhập mô tả loại khoản thu (tuỳ chọn)..."
                    placeholderTextColor={B.textSub}
                    multiline
                    numberOfLines={3}
              ...
              <View style={styles.modalFooter}>
                ...
                <TouchableOpacity style={styles.saveBtn} onPress={handleSave}>
                  ...
                  <Text style={styles.saveBtnText}>
                    {editItem ? "Lưu thay đổi" : "Thêm loại thu"}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
...
export default Cacloaikhoanthu;
